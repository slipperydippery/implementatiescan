...
new Vue({
	...
	components: (_components = { Acties: _Acties2.default }, _defineProperty(_components, 'Acties', _Acties2.default), _defineProperty(_components, 'ScanSlider', _ScanSlider2.default), _components),

	methods: {
		checkThemaAnswered: function checkThemaAnswered(scan, thema) {
		...
		setThemaAnswered: function setThemaAnswered(answered) {
			this.unanswered = answered;
		},

		allAnswered: function allAnswered() {}
	},
...
},{"./components/Actie.vue":13,"./components/Acties.vue":14,"./components/ScanSlider.vue":15,"vue":11,"vue-resource":4}]},{},[16]);
